...
-- Fixed version: Handles Enum creation safely and prevents duplicate inserts.

CREATE EXTENSION IF NOT EXISTS "pgcrypto";

-- 1. Safely create the Enum type (This fixes the error you saw)
DO $$ BEGIN
...
-- 4. Seed Data (Using ON CONFLICT to prevent errors if you run this twice)
